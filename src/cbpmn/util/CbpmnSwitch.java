 ...
 * @generated
 */
public class CbpmnSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CbpmnPackage.DECISION_GATEWAY: {
				DecisionGateway decisionGateway = (DecisionGateway)theEObject;
				T result = caseDecisionGateway(decisionGateway);
				if (result == null) result = caseSplitGateway(decisionGateway);
				if (result == null) result = caseFlowNode(decisionGateway);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CbpmnPackage.PARALLEL_GATEWAY: {
				...
				if (result == null) result = caseSplitGateway(parallelGateway);
				if (result == null) result = caseFlowNode(parallelGateway);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CbpmnPackage.SPLIT_GATEWAY: {
				SplitGateway splitGateway = (SplitGateway)theEObject;
				T result = caseSplitGateway(splitGateway);
				if (result == null) result = caseFlowNode(splitGateway);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CbpmnPackage.FLOW_NODE_INSTANCE: {
				FlowNodeInstance flowNodeInstance = (FlowNodeInstance)theEObject;
				T result = caseFlowNodeInstance(flowNodeInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CbpmnPackage.INTERMEDIATE_EVENT: {
				...
				if (result == null) result = caseFlowNode(intermediateEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Decision Gateway</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Decision Gateway</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDecisionGateway(DecisionGateway object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Split Gateway</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Split Gateway</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSplitGateway(SplitGateway object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Flow Node Instance</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Flow Node Instance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFlowNodeInstance(FlowNodeInstance object) {
		return null;
	}
